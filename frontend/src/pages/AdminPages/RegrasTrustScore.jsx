  ...
  return (
    <div className="admin-container">
      <main className="admin-main">
        ...
        <div className="page-header">
          <div>
            ...
            <p className="regras-subtitulo">
              Ajuste a severidade das penalidades e o impacto do TrustScore no uso da sala.
        ...
        <p className="regras-subtitulo">
          Os 3 níveis definem o TrustScore mínimo exigido pra reservar. A classificação de cada sala
