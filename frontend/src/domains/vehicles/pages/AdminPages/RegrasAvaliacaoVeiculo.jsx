    ...
    <div className="admin-container">
      <main className="admin-main">
        ...
        {regras.length === 0 && (
          <div className="regras-empty">
            ...
            <p className="regras-empty-sub">
              Crie regras para que a IA possa avaliar os check-outs.
            </p>
            <button className="btn-primary" onClick={abrirNovo}>
              ...
              <div key={r.id} className="regra-card">
                ...
                <div className="regra-limiares">
                  <div className="regra-limiar regra-limiar--bonus">
                    ...
                    <div className="regra-limiar-valores">
                      <span className="regra-limiar-cond">
                        nota ≥ <strong>{r.limiBonus}</strong>
                      </span>
                      <span className="regra-limiar-delta">
                        {sign(r.deltaBonus)} pts
                      </span>
                    </div>
                  </div>
                  <div className="regra-limiar regra-limiar--penalidade">
                    ...
                    <div className="regra-limiar-valores">
                      <span className="regra-limiar-cond">
                        nota &lt; <strong>{r.limiPenalidade}</strong>
                      </span>
                      <span className="regra-limiar-delta">
                        {sign(r.deltaPenalidade)} pts
                      </span>
                    </div>
                  </div>
                </div>
                <div className="regra-barra-container">
                  <div className="regra-barra">
                    <div
                      className="regra-zona regra-zona--pen"
                      style={{ width: `${r.limiPenalidade * 10}%` }}
                    />
                    <div
                      className="regra-zona regra-zona--neutra"
                      style={{
                        width: `${(r.limiBonus - r.limiPenalidade) * 10}%`,
                      }}
                    />
                    <div
                      className="regra-zona regra-zona--bonus"
                      style={{ width: `${(10 - r.limiBonus) * 10}%` }}
                    />
                  </div>
                  <div className="regra-barra-labels">
                    <span className="regra-barra-label--pen">
                      penalidade &lt;{r.limiPenalidade}
                    </span>
                    <span className="regra-barra-label--neutra">neutro</span>
                    <span className="regra-barra-label--bonus">
                      bônus ≥{r.limiBonus}
                    </span>
                  </div>
                </div>
      ...
      {modalAberto && (
        <div
          ...
          onClick={(e) =>
            e.target === e.currentTarget && !salvando && setModalAberto(false)
          }
        >
          <div
            style={{
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      set("limiPenalidade")(Number(e.target.value))
                    }
                  />
                  <label
                    className="regras-label"
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      set("deltaPenalidade")(Number(e.target.value))
                    }
                  />
                </div>
              </div>
              ...
              >
                <span style={{ color: "var(--danger)" }}>
                  nota &lt; {form.limiPenalidade} → {sign(form.deltaPenalidade)}{" "}
                  pts
                </span>
                {"  ·  "}
                <span>neutro</span>
                ...
                <span style={{ color: "var(--success)" }}>
                  nota ≥ {form.limiBonus} → +{form.deltaBonus} pts
                </span>
              </p>
            </div>
            <div
