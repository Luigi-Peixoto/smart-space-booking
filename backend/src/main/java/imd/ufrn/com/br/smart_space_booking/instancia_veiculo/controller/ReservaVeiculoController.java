package imd.ufrn.com.br.smart_space_booking.instancia_veiculo.controller;
...
@RestController
@RequestMapping("/reservas-veiculo")
public class ReservaVeiculoController {

    private final ReservaService reservaService;
    private final UsuarioService usuarioService;

    public ReservaVeiculoController(ReservaService reservaService, UsuarioService usuarioService) {
    ...
    public ResponseEntity<List<HorarioOcupadoDTO>> getOcupados(
        ...
        return ResponseEntity.ok(reservaService.findOcupados(veiculoId, localDate));
    }
