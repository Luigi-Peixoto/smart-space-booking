...
export default function Reserva() {
  ...
  if (loading)
    return <div className="loading-screen">Carregando equipamento...</div>;
      ...
      <div className="admin-container">
        <main className="admin-main centered-content">
          <div className="error-screen">
            ...
            <p>
              Não conseguimos localizar os detalhes deste equipamento. <br />
        ...
        <div className="modal-overlay modal-overlay-blurred">
          <div className="modal-card-refinement">
            ...
            <div className="modal-detailed-confirmation">
              <p>
                Sua reserva para <strong>{equipamento?.nome}</strong> em{" "}
            ...
            <div className="reserva-sala-header">
              <div className="sala-info-main">
                <img
                  src={
                    equipamento.imagens?.[0]
                      ? `${FILE_SERVER_URL}/${equipamento.imagens[0]}`
                      : imagemMockada
                  }
                  alt="Equipamento"
                ...
                <div className="sala-textos">
                  <h2 className="sala-nome-destaque">{equipamento?.nome}</h2>
                  <div className="sala-tags">
                    <span>
                      <i className="material-icons">
                        {TIPO_ICONS[equipamento?.tipo] || "devices_other"}
                      </i>{" "}
                      {equipamento?.marca} {equipamento?.modelo}
                    </span>

                    <span>
                      <i className="material-icons">qr_code_2</i> Nº{" "}
                      {equipamento?.numeroSerie}
                    </span>

                    {equipamento?.subItens?.map((subItem) => (
                      <span key={subItem.id} title={subItem.descricao}>
