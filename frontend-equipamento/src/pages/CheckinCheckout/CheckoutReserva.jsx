...
const SLOTS = [
  {
    ...
    instrucao: "Tire uma foto mostrando o aparelho principal após o uso.",
  },
  {
    chave: "kit",
  ...
  const handleSubmit = async (e) => {
    ...
    if (!completo) {
      setErro({
        tipo: "geral",
        mensagem:
          "Envie as 2 fotos exigidas (visão geral e kit completo) para confirmar o check-out.",
      });
      return;
    }
    ...
    try {
      ...
      if (status === 422) {
        ...
        setErro({
          ...
          mensagem:
            mensagemBackend ||
            "Erro ao processar o check-out. Tente novamente.",
        });
      }
    } finally {
      setCarregando(false);
    ...
    <div className="admin-container">
      {carregando && (
        <div className="checkin-loading-overlay">
          <div className="checkin-loading-box">
            ...
            <p>IA avaliando o equipamento...</p>
            <span>
              Calculando Trust Score. Isso pode levar alguns segundos.
            </span>
          </div>
        </div>
      )}
      ...
      <main className="admin-main">
        <div className="page-header">
          <h2 className="page-title">Check-out do Equipamento</h2>
          <p>
            Fotografe o equipamento (visão geral e kit completo) após o uso. A IA irá avaliar e atualizar seu
            Trust Score.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="checkin-form">
                ...
                <div key={slot.chave} className="checkin-slot">
                  ...
                  {foto ? (
                    ...
                    <div
                      ...
                      onClick={() =>
                        !carregando &&
                        document.getElementById(`input-foto-checkout-${slot.chave}`).click()
                      }
                    >
                      ...
                      <input
                        id={`input-foto-checkout-${slot.chave}`}
                        type="file"
                        accept="image/*"
                        capture="environment"
          ...
          <div className="checkin-actions">
            ...
            >
              {carregando ? "Analisando..." : "Confirmar Check-out"}
            </button>
          </div>
        </form>
      </main>
