...
function Perfil() {
  ...
  function formatar(r) {
    ...
    return {
      ...
      sala: r.recursoNome
        ? `Equipamento ${r.recursoNome}`
        : `Equipamento #${r.recursoId}`,
      data: dataFormatada,
  ...
  async function confirmarReporteIncidente() {
    if (!descricaoIncidente.trim()) {
      alert("Por favor, descreva o problema encontrado no equipamento.");
      return;
    }
    try {
      ...
      <main className="perfil-content">
        ...
        <section className="history-section">
          <div className="history-header">
            ...
            <p>Gerencie suas reservas de equipamentos.</p>
          </div>
      ...
      {modalIncidenteAberto && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <textarea
              placeholder="Ex: O projetor não liga, ou o cabo HDMI do kit está danificado..."
