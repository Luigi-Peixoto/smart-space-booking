...
function ModalAuditoria({ tipo, reserva, onConfirmar, onFechar, processando }) {
  ...
  const descricao = isCheckIn
    ? "Fotografe o equipamento antes de utilizá-lo. A IA irá validar as condições do item e do kit."
    : "Fotografe o equipamento após o uso. A IA irá avaliar e classificar o estado do item.";
